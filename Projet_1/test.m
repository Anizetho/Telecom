...
rolloff = 0.40;  % le facteur de rolloff (varie de 0 à 1)
...
% Générer une matrice de M lignes et N colonnes contenant des nombres aléatoires 
% entre 0 et 1 distribués uniformément.
x = randi([0 1], M, N); 

% Emettre la séquence de start
